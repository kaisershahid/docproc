...
const capture_1 = require("./directive-handlers/capture");
exports.registerPlugin = (doc, opts) => {
    ...
    directiveManager.addHandler(new capture_1.DirectiveCaptureStart(), {
        directive: capture_1.DirectiveCaptureStart.DIRECTIVE,
    });
    directiveManager.addHandler(new capture_1.DirectiveCaptureEnd(), {
        directive: capture_1.DirectiveCaptureEnd.DIRECTIVE,
    });
