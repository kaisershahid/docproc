...
exports.Lexer = exports.backslashDefinition = exports.numberDefinition = exports.numberLookahead = exports.LEXEME_KEY_NUM = exports.alphabetDefinition = exports.alphabetLookahead = exports.LEXEME_KEY_ALPHA = void 0;
const types_1 = require("./types");
exports.LEXEME_KEY_ALPHA = "_@_@_alpha";
exports.alphabetLookahead = (content, lexeme, i) => {
...
exports.alphabetDefinition = {
    priority: 1,
    type: "word",
    lookahead: exports.alphabetLookahead,
};
exports.LEXEME_KEY_NUM = "_@_@_num";
exports.numberLookahead = (content, lexeme, i) => {
    // move position back -- lexeme may contain an invalid boundary character
    i -= lexeme.length;
    const substr = content.substr(i);
    let match = substr.match(/^(\d+(\.\d+|)e-?\d+(\.\d+|)|\d*\.\d+|x[\da-fA-F]+|\d+)/);
    if (match) {
        return {
            newLexeme: match[1],
            nextIndex: i + match[1].length,
 ...
 * - exponential (`\d+e-?\d+/`)
 */
exports.numberDefinition = {
    priority: 1,
    type: "number",
    lookahead: exports.numberLookahead,
};
exports.backslashDefinition = {
    priority: 1,
    type: "escape",
...
class Lexer {
    constructor() {
        this.definedLexemes = {
            [exports.LEXEME_KEY_ALPHA]: exports.alphabetDefinition,
            [exports.LEXEME_KEY_NUM]: exports.numberDefinition,
            "\\": exports.backslashDefinition,
        };
        this._lex = "";
    ...
    setLexeme(lexeme, def) {
        this.definedLexemes[lexeme] = def;
        return this;
    }
    mergeLexemes(map, overwrite) {
    ...
    findDefinition(lexeme) {
        ...
        if (isAlphabetic(lexeme[0])) {
            return this.definedLexemes[exports.LEXEME_KEY_ALPHA];
        }
        else if (isNumeric(lexeme[0])) {
            return this.definedLexemes[exports.LEXEME_KEY_NUM];
        }
        return;
    }
    ...
    lex(content, collector) {
         ...
         * @param lexeme
         */
        const _execute_lookahead = (def, lexeme) => {
            var _b;
            const { nextIndex, newLexeme, newLexemeDef, } = def.lookahead
                ? (_b = def.lookahead(content, lexeme, i, def)) !== null && _b !== void 0 ? _b : {} : {};
            ...
            i = nextIndex !== null && nextIndex !== void 0 ? nextIndex : i;
            collector(newLexeme !== null && newLexeme !== void 0 ? newLexeme : lexeme, newLexemeDef !== null && newLexemeDef !== void 0 ? newLexemeDef : def);
        };
        /**
        ...
        const _eval_token = () => {
            ...
            let lex_tmp_def = this.findDefinition(lex_tmp);
    ...
    complete(collector) {
        ...
        this._lex = types_1.LEXEME_COMPLETE;
        this._lex_def = undefined;
        collector(this._lex, this._lex_def);
        return this;
    }
