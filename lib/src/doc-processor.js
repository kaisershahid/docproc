...
class DocProcessor {
    constructor(context) {
        ...
        this.id = ++id;
        const { lexer, parser, blockManager, inlineManager, vars, pluginManager, pluginServicesManager, dataRegistry, } = context !== null && context !== void 0 ? context : {};
        this.lexer = lexer !== null && lexer !== void 0 ? lexer : new lexer_1.Lexer();
        this.parser = parser !== null && parser !== void 0 ? parser : new parser_context_1.ParserContext();
        this.blockManager = blockManager !== null && blockManager !== void 0 ? blockManager : new handler_manager_1.HandlerManager();
        this.inlineManager = inlineManager !== null && inlineManager !== void 0 ? inlineManager : new handler_manager_1.HandlerManager();
        this.pluginManager = pluginManager !== null && pluginManager !== void 0 ? pluginManager : plugins_1.getPluginManager();
        this.pluginServicesManager = pluginServicesManager !== null && pluginServicesManager !== void 0 ? pluginServicesManager : plugins_1.getPluginServicesManager();
        this.dataRegistry = dataRegistry !== null && dataRegistry !== void 0 ? dataRegistry : data_registry_1.makeDataRegistry();
        this.vars = vars !== null && vars !== void 0 ? vars : {};
    ...
    makeCollector() {
        ...
        const endCurrentHandler = () => {
            ...
            if (h === null || h === void 0 ? void 0 : h.handlerEnd) {
                h.handlerEnd();
            }
            return;
        };
        return (lexeme, def) => {
            ...
            if (this.curHandlerDefers) {
                ...
                if (newHandler.getName() != ((_a = this.parser.getCurrentHandler()) === null || _a === void 0 ? void 0 : _a.getName())) {
                    endCurrentHandler();
            ...
            else if (result == types_1.BlockActions.REORDER && (curHandler === null || curHandler === void 0 ? void 0 : curHandler.modifyBlocks)) {
    ...
    findNewHandler(lexeme, def) {
        ...
        return (_b = (_a = eligible[0]) === null || _a === void 0 ? void 0 : _a.cloneInstance()) !== null && _b !== void 0 ? _b : new paragraph_handler_1.ParagraphHandler();
    }
