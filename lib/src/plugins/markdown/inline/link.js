...
class Link {
    ...
    resolveUrl() {
        ...
        if (this.mode == LinkMode.ref) {
            ...
            return (_a = ref === null || ref === void 0 ? void 0 : ref.url) !== null && _a !== void 0 ? _a : url;
        }
        return url;
    }
    toImage() {
...
class BaseLinkHandler extends base_1.BaseHandler {
    ...
    getNewLinkInstance() {
        ...
        return new Link({
            context,
            text: context === null || context === void 0 ? void 0 : context.getInlineFormatter(),
            url: context === null || context === void 0 ? void 0 : context.getInlineFormatter(),
        });
    }
