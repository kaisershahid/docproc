...
class PluginManager {
    ...
    registerFromModule(name, modPath) {
        ...
        try {
            this.register(name, require(localModPath !== null && localModPath !== void 0 ? localModPath : modPath).registerPlugin);
        }
        catch (e) {
            // @todo report error
            console.error(e);
...
class PluginServicesManager {
    ...
    getService(pluginName, key) {
        var _a;
        return (_a = this.servicesByPlugins[pluginName]) === null || _a === void 0 ? void 0 : _a[key];
    }
}
