...
class DirectiveInclude {
    invokeDirective(def, ctx) {
        ...
        const rootDir = (_b = (_a = ctx.vars.sys) === null || _a === void 0 ? void 0 : _a.sourceRoot) !== null && _b !== void 0 ? _b : process.cwd();
    ...
    processFile(def, ctx, filePath) {
        try {
            ...
            const retVal = require(filePath)[func](ctx, def, {
                parameters,
                makeProcessor: (ctxOverride) => {
                    return new doc_processor_1.DocProcessor({
                        ...ctx,
                        dataRegistry: new data_registry_1.DataRegistry(),
                        vars: {},
                        ...(ctxOverride !== null && ctxOverride !== void 0 ? ctxOverride : {}),
                    });
                },
            });
