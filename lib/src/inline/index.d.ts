import { HandlerInterface, InlineHandlerType, LexemeDef, InlineActions } from "../types";
export interface InlineHandlerInterface extends HandlerInterface<InlineHandlerType> {
    /**
    ...
    addChild: (child: HandlerInterface<InlineHandlerType>) => InlineHandlerInterface;
