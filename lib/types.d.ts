...
export declare type LexemeDef = {
     ...
     */
    lookahead?: (content: string, lexeme: string, nextIdx: number, curDef: LexemeDef) => LexemeLookaheadReturn | any;
};
/**
 * The return value from the lookahead determines which lexeme to emit and how far ahead to jump in the input.
 */
export declare type LexemeLookaheadReturn = {
    /**
 ...
 */
export declare const LEXEME_COMPLETE = "";
/**
 ...
 */
export declare type LexemeConsumer = (lexeme: string, def?: LexemeDef) => any;
/**
 ...
 */
export declare class GenericHandlerType {
}
export declare class BlockHandlerType extends GenericHandlerType {
}
 ...
 */
export declare enum BlockActions {
    /**
 ...
 */
export declare type HandlerAddOptions = {
    before?: string;
    after?: string;
    at?: string;
};
export interface HandlerManagerInterface<T extends GenericHandlerType> extends ContextAwareInterface {
    addHandler: (handler: HandlerInterface<T>, options?: HandlerAddOptions) => HandlerManagerInterface<T>;
 ...
 */
export declare enum InlineActions {
    /**
 ...
 */
export declare const InlineFormatterDummy: InlineFormatterInterface;
/**
 ...
 */
export declare type PluginOptionsMap = {
 ...
 */
export declare type DocumentSettings = AnyMap & {
    /**
 ...
 */
export declare type PluginOptions = AnyMap;
/**
 * Hook that allows a plugin to inject itself into the processor.
 */
export declare type PluginEntry = (doc: DocProcessor, opts?: PluginOptions) => void;
/**
 ...
 */
export declare type SysSettings = {
    /**
 ...
 */
export declare type DocProcContext = {
    /**
